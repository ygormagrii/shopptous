 ...
 */
public class ListaAbertos extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lista_abertos);
        this.getActionBar().setTitle("Shopptous");

        Bundle bundle = getIntent().getExtras();
        id_prod = bundle.getString("id_prod");
    ...
    public class select extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... arg0) {
            ...
            UserAccessSession userAccess = UserAccessSession.getInstance(ListaAbertos.this);
            ...
            nameValuePairs.add(new BasicNameValuePair("id_prod", id_prod));

            try {
                HttpClient httpclient = new DefaultHttpClient();
                HttpPost httppost = new HttpPost("http://shopptous.com/pedidos_lista_abertos.php");
        ...
        protected void onPostExecute(String result) {
            ...
            for (int i=0; i < pedidos_id.size(); i++) {
                ...
                if(i == 0){
                    pedidoId.setText("Resumo do Pedido #" + id_prod);
                    String[] lista = {pedidos_descricao.get(0)+"  "+pedidos_qtd.get(0)};
                    ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(ListaAbertos.this, android.R.layout.simple_list_item_1, lista);
                ...
                listaPedido.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> lista, View item, int posicao, long id) {
                        ...
                        if (posicao == 0) {
                            int var_posicao = 1;
                            AlertDialog.Builder builder = new AlertDialog.Builder(ListaAbertos.this);//Cria o gerador do AlertDialog
