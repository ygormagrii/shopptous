 ...
 */
public class DeletaItem extends Activity {
    ...
    class delete extends android.os.AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(DeletaItem.this);
        ...
        protected String doInBackground(String... arg0) {
            ...
            UserAccessSession userAccess = UserAccessSession.getInstance(DeletaItem.this);
            ...
            try
            {
                ...
                HttpPost httppost = new HttpPost("http://shopptous.compedidos_del.php");
        ...
        protected void onPostExecute(String result) {
            ...
            Intent intent = new Intent(DeletaItem.this, FinalizarPedido.class);
